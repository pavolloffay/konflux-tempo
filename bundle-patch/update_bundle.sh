...
export TEMPO_QUERY_IMAGE_PULLSPEC="quay.io/redhat-user-workloads/rhosdt-tenant/tempo/tempo-query@sha256:15d8600b15784df604a91bb91f36cf18ef34c96f46716c1851fd0096681814d9"
# separate due to merge conflicts
