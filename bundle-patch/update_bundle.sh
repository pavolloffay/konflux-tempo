...
# separate due to merge conflicts
export TEMPO_GATEWAY_IMAGE_PULLSPEC="quay.io/redhat-user-workloads/rhosdt-tenant/tempo/tempo-gateway@sha256:62cf23a9db859935f119fe203823fb3b08177b074be93243a835fe30da76f1fd"
# separate due to merge conflicts
