...
# separate due to merge conflicts
export TEMPO_OPA_IMAGE_PULLSPEC="quay.io/redhat-user-workloads/rhosdt-tenant/tempo/tempo-opa@sha256:6a37dc32926fb9db6e099ae5c54c74861bbed91e3630f4e599811cca531ecf3c"
# Separate due to merge conflicts
